...
@InputType()
class SubmissionCreateNestedManyWithoutLanguagesInput {
...
export { SubmissionCreateNestedManyWithoutLanguagesInput as SubmissionCreateNestedManyWithoutLanguagesInput };
