...
@InputType()
class ResultCreateNestedManyWithoutSubmissionsInput {
...
export { ResultCreateNestedManyWithoutSubmissionsInput as ResultCreateNestedManyWithoutSubmissionsInput };
